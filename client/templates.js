(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">barbara</a></div><ul data-hook="brews" class="nav navbar-nav"></ul></div></nav><div class="container"><main data-hook="page-container"></main></div></body>';
    };
    ...
    // includes/brew.jade compiled template
    templatizer["includes"]["brew"] = function tmpl_includes_brew() {
        return '<li><a data-hook="brewlink"></a></li>';
    };

    // includes/graph.jade compiled template
    templatizer["includes"]["graph"] = function tmpl_includes_graph() {
        return '<div data-hook="temperatures" style="width: 100%; height: 500px; margin: auto"></div>';
    };

    // pages/brew.jade compiled template
    templatizer["pages"]["brew"] = function tmpl_pages_brew() {
        return '<section class="page brew"><h1 data-hook="name"></h1><div data-hook="graph"></div></section>';
    };
